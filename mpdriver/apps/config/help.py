HELP = {
    'apps.config.args:file_local': 'Use the local configuration file (within the project directory).',
    ...
    'apps.config.args:yes': 'Automatically confirm any prompts, useful for scripts or batch operations.',
    'apps.config.args:copy': 'Copy configuration settings from another configuration file.',
    'apps.config.args:delite': 'Delete a specific configuration item.'
}